...
public class BlockHandler {
    ...
    public static final RegistryObject<Block> mino_large_table_yellow = block(SmallGameTable::new,
    ...
    public static final RegistryObject<Block> mino_table_extender = block(MinoTableExtender::new,
                                                                          "mino_table_extender");
