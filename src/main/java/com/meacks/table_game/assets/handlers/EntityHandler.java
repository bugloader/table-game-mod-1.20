...
public class EntityHandler {
    ...
    public static final int[][] colorLists = {
        {6737151, 16756938}, {16777215, 16777215}, {5635925, 5635925},
        {6737151, 6737151}, {16756938, 16756938}, {16753920, 16753920},
        {15616811, 15616811}};
    ...
    public static void summonFireWork(UseOnContext useOnContext) {
        ...
        FireworkRocketEntity fireworkRocketEntity =
            new FireworkRocketEntity(level,
