...
public class BlockEntityHandler {
    ...
    public static final RegistryObject<BlockEntityType<MinoTableBlockEntity>> minoTableBlockEntity =
            BLOCK_ENTITY_DEFERRED_REGISTER.register("mino_table", () -> BlockEntityType.Builder.
                    of(MinoTableBlockEntity::new, BlockHandler.mino_table.get()).build(DSL.remainderType()));
    public static final RegistryObject<BlockEntityType<MinoLargeTableBlockEntity>> minoLargeTableBlockEntity =
            BLOCK_ENTITY_DEFERRED_REGISTER.register("mino_large_table", () -> BlockEntityType.Builder.
                    of(MinoLargeTableBlockEntity::new, BlockHandler.mino_large_table.get()).build(DSL.remainderType()));
    public static final RegistryObject<BlockEntityType<MinoTableExtenderBlockEntity>> minoTableExtenderBlockEntity =
            BLOCK_ENTITY_DEFERRED_REGISTER.register("mino_table_extender", () -> BlockEntityType.Builder.
                    of(MinoTableExtenderBlockEntity::new, BlockHandler.mino_table_extender.get()).build(DSL.remainderType()));
