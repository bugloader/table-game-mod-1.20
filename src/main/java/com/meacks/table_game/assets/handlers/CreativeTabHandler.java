...
public class CreativeTabHandler {
    ...
    public static final RegistryObject<CreativeModeTab> TABLE_GAME_TAB =
        CREATIVE_MODE_TABS.register("table_game_tab",
                                    () -> CreativeModeTab
                                        .builder()
                                        .title(
                                            Component.translatable(
                                                "itemGroup.table_game_tab"))
                                        .icon(
                                            ItemHandler.mino_hand_card.get()::getDefaultInstance)
                                        .displayItems(
                                            (parameters, output) -> {
